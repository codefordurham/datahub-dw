...
CREATE TABLE durham_ltdbacs_7016_tr (gid serial,
   ...
   mgrent12 DOUBLE PRECISION,
   mgrent12a17 DOUBLE PRECISION,
   ...
   rentoc16 DOUBLE PRECISION,
   prentoc16 DOUBLE PRECISION,
   mhmval16 DOUBLE PRECISION,
   mgrent16 DOUBLE PRECISION,
   mrent16 DOUBLE PRECISION,
   mhmval16a17 DOUBLE PRECISION,
   mgrent16a17 DOUBLE PRECISION,
   ...
   cmgrent1216a17 DOUBLE PRECISION,
   pcmgrent1216a17 DOUBLE PRECISION,
